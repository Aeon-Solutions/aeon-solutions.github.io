...
export const experience: Experience[] = [
  {
    ...
    summary:
      'Liderança e gestão de equipes (N1, N2 e N3) com foco em excelência no atendimento.',
    highlights: [
      'Liderança e desenvolvimento de equipes de suporte técnico (N1, N2 e N3), garantindo a excelência no atendimento',
